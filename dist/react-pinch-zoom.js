(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["ReactPinchZoom"] = factory(require("react"), require("react-dom"));
	else
		root["ReactPinchZoom"] = factory(root["React"], root["ReactDOM"]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _photoswipeUiDefault = __webpack_require__(5);
	...
	(function (root, factory) {
	  ...
	  return function (template, UiClass, items, options) {
	    ...
	    */
	    ...
	    var // Return true if offset is out of the bounds
	    ...
	    var // find the closest parent DOM element
	    ...
	    var // Pointerdown/touchstart/mousedown handler
	    ...
	    var // Pointermove/touchmove/mousemove handler
	    ...
	    var // Pointerup/pointercancel/touchend/touchcancel/mouseup event handler
	    ...
	    var // Returns object with data about gesture
	    ...
	    var // Resets zoom if it's out of bounds
	...
	(function (root, factory) {
	  ...
	  return function (zvuiPinch, helper) {
	    ...
	    */
	    ...
	    var _shareButton = void 0;
	    var _shareModal = void 0;
	    var _shareModalHidden = false;
	    ...
	    var _defaultUIOptions = {
	      ...
	      getTextForShare: function getTextForShare() /* shareButtonData */{
	        return zvuiPinch.currItem.title || '';
	      },
	    ...
	    var // add class when there is just one item in the gallery
	    ...
	    var _toggleShareModalClass = function _toggleShareModalClass() {
	      _toggleZvuiPinchClass(_shareModal, 'share-modal--hidden', _shareModalHidden);
	    };

	    var _toggleShareModal = function _toggleShareModal() {
	      // Hack to not enable share modal
	      return false;
	      ...
	      if (!_shareModalHidden) {
	        ...
	        setTimeout(function () {
	          if (!_shareModalHidden) {
	            helper.addClass(_shareModal, 'zvui-pinch__share-modal--fade-in');
	          }
	        }, 30);
	      } else {
	        helper.removeClass(_shareModal, 'zvui-pinch__share-modal--fade-in');
	        setTimeout(function () {
	          if (_shareModalHidden) {
	            _toggleShareModalClass();
	          }
	    ...
	    var _openWindowPopup = function _openWindowPopup(e) {
	      e = e || window.event;
	      var target = e.target || e.srcElement;

	      zvuiPinch.shout('shareLinkClick', e, target);
	      ...
	      window.open(target.href, 'zvui-pinchshare', 'scrollbars=yes,resizable=yes,toolbar=no,location=yes,width=550,height=420,top=100,left=' + (window.screen ? Math.round(screen.width / 2 - 275) : 100));
	    ...
	    var _updateShareURLs = function _updateShareURLs() {
	      var shareButtonOut = '';
	      var shareButtonData = void 0;
	      var shareURL = void 0;
	      var image_url = void 0;
	      var page_url = void 0;
	      var share_text = void 0;
	      ...
	      for (var i = 0; i < _options.shareButtons.length; i++) {
	        ...
	        shareButtonOut += '<a href="' + shareURL + '" target="_blank" class="zvui-pinch__share--' + shareButtonData.id + '"' + (shareButtonData.download ? 'download' : '') + '>' + shareButtonData.label + '</a>';
