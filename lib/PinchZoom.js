    ...
    _createClass(PinchZoom, [{
        ...
        value: function render() {
            ...
            return React.createElement(
                ...
                React.createElement('div', { className: BASE_CLASS + '__bg' }),
                React.createElement(
                    'div',
                    ...
                    React.createElement(
                        ...
                        React.createElement('div', { className: BASE_CLASS + '__item' }),
                        React.createElement('div', { className: BASE_CLASS + '__item' }),
                        React.createElement('div', { className: BASE_CLASS + '__item' })
                    ),
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement('button', { className: BASE_CLASS + '__button ' + BASE_CLASS + '__button--close', title: 'Close (Esc)' }),
                            React.createElement('div', { className: BASE_CLASS + '__preloader' })
                        )
                    )
                )
            );
