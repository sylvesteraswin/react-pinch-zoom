    ...
    _createClass(PinchZoom, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement('div', { className: BASE_CLASS + '__scroll-wrap' }),
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement('button', { className: BASE_CLASS + '__button ' + BASE_CLASS + '__button--share', title: 'Share' }),
                        _react2.default.createElement('button', { className: BASE_CLASS + '__button ' + BASE_CLASS + '__button--fs', title: 'Toggle fullscreen' }),
                        _react2.default.createElement('button', { className: BASE_CLASS + '__button ' + BASE_CLASS + '__button--zoom', title: 'Zoom in/out' }),
                        _react2.default.createElement(
                            'div',
                            { className: BASE_CLASS + '__preloader' },
                            _react2.default.createElement(
                                'div',
                                { className: BASE_CLASS + '__preloader__icn' },
                                _react2.default.createElement(
                                    'div',
                                    { className: BASE_CLASS + '__preloader__cut' },
                                    _react2.default.createElement('div', { className: BASE_CLASS + '__preloader__donut' })
                                )
                            )
                        )
                    )
...
var _initialiseProps = function _initialiseProps() {
    ...
    this.openPhotoSwipe = function (props) {
        ...
        _this2.photoSwipe = new Photoswipe(zvuiPinchElement, PhotoswipeUIDefault, items, options);
