...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ZVUIPunch = factory();
  }
}(this, function(require, exports, module) {

return function(template, UiClass, items, options) { //function(template, UiClass, items, options)
...
var _gestureStartTime,
  ...
  _closestElement = function(el, fn) {
    ...
    if (el.getAttribute('class') && el.getAttribute('class').indexOf('zvui-pinch__scroll-wrap') > -1) {
      return false;
    }
